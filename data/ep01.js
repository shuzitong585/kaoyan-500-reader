window.EP01_DATA = {
  ...
  words: {
    divorce: { phonetic: "/dɪˈvɔːs/", pos: "n. / v.", context: "离婚；解除婚姻关系", core: "离婚；与……离婚", meanings: ["n. 离婚；婚姻解除", "v. 与……离婚", "v. 使分离；使脱离"], mnemonic: "marriage 把两个人联结，divorce 则解除这段婚姻关系。", family: ["divorced adj. 离婚的", "divorcee n. 离婚者"], collocations: ["divorce agreement｜离婚协议", "get a divorce｜离婚", "divorce rate｜离婚率"], confusables: ["divorce：依法解除婚姻", "separate：分开，不一定已经离婚"], examUsage: "作动词时可直接接人：divorce sb.；表达“与某人离婚”也常用 get divorced from sb.", errorPoint: "表示“与某人离婚”不用 divorce with sb.", example: { en: "They decided to get a divorce after years of conflict.", zh: "多年的矛盾之后，他们决定离婚。" }, storyHook: "她把 divorce 协议推到陆沉舟面前，想正式结束这段婚姻。" },
    indifferent: { phonetic: "/ɪnˈdɪfrənt/", pos: "adj.", context: "冷淡的；漠不关心的", core: "冷漠的；不关心的；无所谓的", meanings: ["adj. 漠不关心的；冷淡的", "adj. 不感兴趣的；不在乎的", "adj. 一般的；平庸的｜较少见"], breakdown: "记忆拆解：in- = 不；different = 不同的 → 觉得各种选择没什么不同 → 无所谓、不在乎。", family: ["indifference n. 冷漠；不关心", "indifferently adv. 冷淡地；漠不关心地"], collocations: ["be indifferent to｜对……漠不关心", "remain indifferent to｜对……仍无动于衷", "indifferent attitude｜冷漠的态度"], confusables: ["indifferent：不关心、无所谓", "uninterested：没有兴趣", "neutral：保持中立"], examUsage: "考研阅读中常见 be indifferent to，强调对某人或某事缺乏关心，而不只是表情冷淡。", errorPoint: "固定介词是 to：be indifferent to sth.", example: { en: "We cannot remain indifferent to social inequality.", zh: "我们不能对社会不平等无动于衷。" }, storyHook: "离婚协议已经推到面前，他的神色仍然 indifferent。" },
    appearance: { phonetic: "/əˈpɪərəns/", pos: "n.", context: "外表；神态", core: "外表；出现；露面", meanings: ["n. 外表；外貌", "n. 出现；露面", "n. 表面现象"], breakdown: "appear = 出现；显得；-ance = 名词后缀 → appearance = 出现；外表。", family: ["appear v. 出现；似乎", "apparent adj. 显然的；表面上的", "apparently adv. 看来；显然"], collocations: ["physical appearance｜外貌", "make an appearance｜露面", "outward appearance｜外在表现"], confusables: ["appearance：可指外貌，也可指“出现”", "look：日常表达中的样子、神情"], examUsage: "不要只记“外貌”。make an appearance 表示“出现、露面”；by appearances 表示“从表面看”。", errorPoint: "appearance 是可数名词时可指一次公开露面；表示人的整体外貌时常用单数。", example: { en: "Appearances can be misleading when facts are incomplete.", zh: "事实不完整时，表象可能会误导人。" }, storyHook: "陆沉舟冷淡的 appearance 看不出情绪，也没有透露他为何拒绝签字。" },
